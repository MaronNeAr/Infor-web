...
export default {
    ...
    data() {
        return {
            ...
            cardTitle: null,
            cardTypes: [
              {text: '智能发票', value: 'multiple_invoice'},
              {text: '增值税发票', value: 'vat_invoice'},
              {text: '银行回单', value: 'bank_receipt_new'},
              {text: '定额发票', value: 'quota_invoice'},
              {text: '飞机行程单', value: 'air_ticket'},
    ...
    methods: {
      ...
      async uploadCard() {
        const formData = new FormData();
            ...
            await axios.post('/api/bill/update', formData, {
                    headers: {
